...
- Next: continue Matthew (the hillside teaching, traditional ch. 5–7) → keep appending pages; grow lexicon; then the reader webpage (user's existing HTML draft in chat can be upgraded to load this JSON with stemming for word→lexicon matching).
